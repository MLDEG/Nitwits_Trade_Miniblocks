# Trade init
data merge storage nitwit_trades:trade { "/": { maxUses: 8, buy: { id: "minecraft:emerald", count: 16 }, sell: { id: "minecraft:player_head", components: { "minecraft:profile": { properties: [{ name: "textures" }] } } }, xp: 2, uses: 0, priceMultiplier: 0, specialPrice: 0, rewardExp: 1 } }
